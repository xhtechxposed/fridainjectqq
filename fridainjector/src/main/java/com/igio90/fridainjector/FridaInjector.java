...
public class FridaInjector {
    ...
    public void inject(FridaAgent fridaAgent, String packageName, boolean spawn,String qq) {
        if (mInjector == null) {
...
//                }
    ...
    private void inject(String packageName, String agentPath) {
        Result r =  RootManager.getInstance().runCommand(mInjector.getPath() + " -n " + packageName +
                " -s " + agentPath + " -e");
        Log.e("FridaAndroidInject",r.getMessage());
    }
